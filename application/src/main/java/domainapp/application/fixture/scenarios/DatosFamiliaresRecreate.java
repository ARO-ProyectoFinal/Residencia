...
public class DatosFamiliaresRecreate extends FixtureScript {
    ...
    public final List<String> Narentesco = Collections.unmodifiableList(Arrays.asList("Hermano", "Hermano", "Hija", "Hermana", "Hermano", "Hijo"));
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        for (int i = 0; i < NombreCompletoFamiliar.size(); i++) {
            ...
            fs.setParentesco(Narentesco.get(i));
